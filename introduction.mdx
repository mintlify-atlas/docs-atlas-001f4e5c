...
<Note>
UIFM uses a protocol-based approach, meaning you can implement the frontend in any framework. The official [uimf-svelte](https://github.com/unops/uimf-svelte) client demonstrates this with Svelte.
</Note>
...
UIFM automatically generates metadata describing this form:
...
UIFM consists of two main packages:
